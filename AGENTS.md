...
- ✅ Cada skill contém cabeçalho `skill`, `version`, `procedure_scope`, `task` e seção `## Conteúdo` com estrutura extraída do documento original
- ✅ Foundation `agent_logs` criada (migration `20260428000002`) como ledger append-only com RLS, views derivadas e bloqueio de UPDATE/DELETE
...
skills/            # Fase 4 prep: protocolos clínicos convertidos para skills MessageAgent
supabase/
